...
authRouter.post("/token", tokenDecoding, tokenValidation, tokenSignin);
authRouter.post("/signout", tokenDecoding, signout);
authRouter.put("/userUpdate", validator(signupSchema, true), tokenDecoding, emailExists(), tokenValidation, hashPassword, userUpdateController);
